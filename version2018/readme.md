...
# Weather Prediction Task (WPT) for the study of category learning in humans 
...
* [Experimental Task Scripts](Scripts_Experimental_Task/) — Paradigm code and behavioral collection.
* [Analysis Scripts](Scrips_Analysis/) — Data processing and statistical analysis.
* [Figure Scripts](Scripts_Figures_2026ijpp/) — Scripts for generating paper figures.
